...
def main():
    ...
    args.add_argument("--sims_train_test_path", type=str, default=None, \
    ...
    args.add_argument("--gt_idx_path", type=str, default=True, help="path to the ground truth index")
    args.add_argument("--test_query_masks_path",
            type=str, default=None,
            help="path to the query masks")
    args.add_argument("--defense", type=bool, default=False)
    ...
    gt_idx_path = args.get("gt_idx_path", None)
    if gt_idx_path:
        gt_idx = pkl.load(open(gt_idx_path, 'rb'))
    else:
        gt_idx = None
    ...
    # print("test_test.shape: ", test_test.shape)
    ...
    if args["defense"]:
        ...
        print(metric.t2v_metrics(test_test_normalized, gt_idx, test_query_masks))
