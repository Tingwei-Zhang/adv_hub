...
def imagebind_huge(pretrained=False):
    ...
    if pretrained:
        if not os.path.exists("../adversarial_illusions/.checkpoints/imagebind_huge.pth"):
            print(
        ...
        model.load_state_dict(torch.load("../adversarial_illusions/.checkpoints/imagebind_huge.pth"))
